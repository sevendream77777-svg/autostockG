...
try:
    ...
    def send_kakao_message(text=None, image_path=None, _error=_e):
        print(f"[KAKAO] 모듈 오류: {_error}")
        return False

    def send_sms_message(*args, **kwargs): return False
    def send_telegram_message(*args, **kwargs): return False

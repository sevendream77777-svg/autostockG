# ============================================================
# build_HOJ_DB_RESEARCH.py  (V31 - 15피처 기반 HOJ 연구용 DB)
# ============================================================
...
SAVE_FILE = get_path("HOJ_DB", "RESEARCH", "HOJ_DB_RESEARCH_V31.parquet")
...
# 메인 DB 작성
# ------------------------------------
def build_hoj_research_db():
    print("=== [RESEARCH] HOJ_DB V31 생성 시작 ===")
